...
public sealed class GoSafeProtocolDecoderTest : ProtocolTestBase
{
    ...
    [Fact]
    public void TestDecodeRstNoLocation()
    {
        var decoder = CreateDecoder();

        VerifyPositions(decoder, false, Buffer("*GS06,357330050846344,RST#"));
    }

    [Fact]
    public void TestDecodeSingleTemperatureSensorAttribute()
    {
        var decoder = CreateDecoder();
        ...
        VerifyAttribute(decoder, Buffer(
            ...
            Position.PrefixTemp + 0, 22.5);
    }

    [Fact]
    public void TestDecodeGs06MultiSegmentPositions1()
    {
        var decoder = CreateDecoder();
    ...
    [Fact]
    public void TestDecodeGs06DualPositions1()
    {
        var decoder = CreateDecoder();
    ...
    [Fact]
    public void TestDecodeGs06SinglePosition()
    {
        var decoder = CreateDecoder();
    ...
    [Fact]
    public void TestDecodeGs06IwdZeroSensors()
    {
        var decoder = CreateDecoder();
    ...
    [Fact]
    public void TestDecodeGs06CotWithDashes()
    {
        var decoder = CreateDecoder();
    ...
    [Fact]
    public void TestDecodeGs06ZeroAdc()
    {
        var decoder = CreateDecoder();
    ...
    [Fact]
    public void TestDecodeGs26EmptyGsmFields()
    {
        var decoder = CreateDecoder();
    ...
    [Fact]
    public void TestDecodeGs56MultiSegmentNoLocation()
    {
        var decoder = CreateDecoder();
    ...
    [Fact]
    public void TestDecodeGs26EmptyGsmFields2()
    {
        var decoder = CreateDecoder();
    ...
    [Fact]
    public void TestDecodeGs56NotNull1()
    {
        var decoder = CreateDecoder();
    ...
    [Fact]
    public void TestDecodeGs56NotNull2()
    {
        var decoder = CreateDecoder();
    ...
    [Fact]
    public void TestDecodeGs56NotNullDual()
    {
        var decoder = CreateDecoder();
    ...
    [Fact]
    public void TestDecodeGs16ObdAndFuel()
    {
        var decoder = CreateDecoder();
    ...
    [Fact]
    public void TestDecodeGs16MultiCellGsm()
    {
        var decoder = CreateDecoder();
    ...
    [Fact]
    public void TestDecodeGs16NoTrailingHash()
    {
        var decoder = CreateDecoder();
    ...
    [Fact]
    public void TestDecodeGs16ObdNoTrailingHash1()
    {
        var decoder = CreateDecoder();
    ...
    [Fact]
    public void TestDecodeGs16ObdNoTrailingHash2()
    {
        var decoder = CreateDecoder();
    ...
    [Fact]
    public void TestDecodeGs16IncompleteIsNull()
    {
        var decoder = CreateDecoder();

        VerifyNull(decoder, Buffer("*GS16,351535058709775"));
    }

    [Fact]
    public void TestDecodeGs16MultiSegmentObd()
    {
        var decoder = CreateDecoder();
    ...
    [Fact]
    public void TestDecodeGs16SysHeader()
    {
        var decoder = CreateDecoder();
    ...
    [Fact]
    public void TestDecodeGs16MultiSegmentObdWithSys()
    {
        var decoder = CreateDecoder();
