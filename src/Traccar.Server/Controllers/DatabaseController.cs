...
/// <summary>
/// Port of MockApi's DatabaseStatsEndpoints — reads PostgreSQL's own built-in stats views
/// (pg_stat_database, pg_stat_user_tables, pg_stat_activity) directly via ADO.NET rather than
/// EF entities, since none of this is application data.
/// </summary>
[ApiController]
